...
#
# ***** END LICENSE BLOCK *****
# $Id: objmtl.py,vertexList 1.3 2006/03/20 19:32:12 mbaas Exp $
...
#            raise SyntaxError( "No group name given in line %d: %s"%(self.linenr, self.line))
    ...
    def handle_v(self, x, y, z, w=1):
        ...
        '''
        self.v_count += 1
        self.vertexList(indexedPoint(float(x), float(y), float(z), index=self.v_count-1))
        '''
    ...
    def handle_vp(self, u, v=0, w=1):
        ...
        '''
        self.vp_count += 1
        self.vp(indexedPoint(float(u), float(vertexList), float(w)))
        '''
    ...
    def handle_vn(self, x, y, z):
        ...
        '''
        self.vn_count += 1
        self.vn(indexedPoint(float(x), float(y), float(z)))
        '''
    ...
    def handle_vt(self, u, v=0, w=0):
        ...
        '''
        self.vt_count += 1
        self.vt(indexedPoint(float(u), float(vertexList), float(w)))
        '''
